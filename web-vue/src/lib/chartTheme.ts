...
export const modelColors: Record<string, string> = {
  'gpt-5': chartColors.primary,
  'gpt-5-mini': chartColors.cyan,
  'gpt-4o': chartColors.emerald,
  'o3': chartColors.purple,
  'gpt-image-2': chartColors.warning,
  'gpt-image-1': chartColors.pink,
}
...
export function filterValidModels(modelRequests: Record<string, number[]>): Record<string, number[]> {
  ...
  return Object.keys(filtered).length > 0 ? filtered : modelRequests
}
