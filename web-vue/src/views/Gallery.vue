<template>
  <div class="gallery-page">
    ...
    <PagePanel flush>
      ...
      <StateBlock v-if="!hasLoadedOnce && files.length === 0" class="gallery-state-block">
        <template #media>
...
import { ActionRow, DateRangeInputs, FilterToolbar, GalleryImageCard, GalleryLightbox, GalleryTagEditorModal, ListPagination, MetricStrip, OperationProgressModal, PagePanel, PanelHeader, SelectionBulkBar, StateBlock } from '@/components/ai'
