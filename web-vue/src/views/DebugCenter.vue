<template>
  <div class="debug-center space-y-5">
    <PagePanel class="debug-center__panel">
      ...
      <SegmentedTabs v-model="activeTab" :options="tabOptions" aria-label="调试工具" />
    </PagePanel>
...
import { Button, Input, SegmentedTabs } from 'nanocat-ui'
import { CodeBlock, PagePanel, PanelHeader, StateBadge } from '@/components/ai'
