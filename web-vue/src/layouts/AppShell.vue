          ...
          <div class="flex items-center gap-3">
            ...
            <div class="flex min-w-0 flex-wrap items-center gap-2">
              ...
              <span
                ...
                class="ui-chip text-[11px] text-muted-foreground"
              >
                {{ sidebarVersionLabel }}
              </span>
            </div>
...
const supportedChatModels = computed(() => resolveChatModels(settingsStore.settings))
const supportedImageModels = computed(() => resolveImageModels(settingsStore.settings))
